<template>
  <div id="app">
    ...
    <div class="wrapper">
      <AddCostBtn @openModalWindow="modalWindowShow" />
      <!-- <button @click="onModalClose">Close</button> -->
      <br />
      <div class="everyday">
        <p>Everyday costs</p>
        <router-link to="/add/payment/Food?value=200" class="link"
          >Food
        </router-link>
        <br />
        <router-link to="/add/payment/Transport?value=50" class="link"
          >Transport
        </router-link>
        <br />
        <router-link to="/add/payment/Entertainment?value=2000" class="link"
          >Entertainment
        </router-link>
      </div>
      <!-- <AddPaymentForm
        @addNewPayment="addNewPaymentData"
        v-if="AddPaymentFormVisible"
        :category-list="categoryList"
        :openAddPaymentForm="false"
      /> -->
      <br />
    ...
    <router-view @addNewPayment="addNewPaymentData"> </router-view>
    <transition name="fade">
      <ModalWindow :settings="settings" v-if="modalWindowName"/>
    </transition>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    onShown(settings) {
      ...
      console.log(678, settings, this.modalWindowName)
    },
    onHide() {
