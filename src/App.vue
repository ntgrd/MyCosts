<template>
  <div id="app">
    ...
    <div class="wrapper">
      ...
      <div class="everyday">
      <p>Everyday costs</p>
      <router-link to="/add/payment/Food?value=200" class="link" >Food </router-link>
       <br/>
     <router-link to="/add/payment/Transport?value=50" class="link">Transport </router-link>
      <br/>
     <router-link to="/add/payment/Entertainment?value=2000" class="link">Entertainment </router-link>
      </div>
